...
@app.route("/normallogin", methods=['GET','POST'])
def normallogin():
    print('11111111111111')
    if request.method == 'POST':
        # print('ssss')
...
@app.route("/addcoursestouser", methods=['GET','POST'])
...
@app.route("/deletecartproduct", methods=['GET','POST'])
...
@app.route("/deleteallcartproduct", methods=['GET','POST'])
...
# @app.route("/checkcartproducts", methods=['GET','POST'])
...
@app.route("/getallcartproducts", methods=['GET','POST'])
